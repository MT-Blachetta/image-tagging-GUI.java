...
/**
 * Handles button actions from the {@link InfoPanel}. This class controls the
 * workflow for navigating through image files and recording click coordinates
 * to a track file.
 */
public class ButtonEvent extends AbstractAction {
        ...
        /**
         * Loads the previous image in the sequence and updates the frame index.
         */
        ...
        /**
         * Extracts directory and starting index from the first selected image
         * path.
         */
        ...
        /**
         * Helper that enables or disables the "next" button depending on
         * whether another image is available.
         */
